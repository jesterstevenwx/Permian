...
e_we_d02 = 811 #* Update for the project
e_sn_d02 = 1201 #* Update for the project
parent_grid_ratio_d02 = 15 #* Update for project (dx and dy for d02 will be d01_dx/grid_ratio or d01_dy/grid_ratio)
i_parent_start_d02 = 149 #* Update for the project (use WRF_Domain_Wizard)
j_parent_start_d02 = 30 #* Update for the project (use WRF_Domain_Wizard)
...
wps_dir = '$WORK/WPS' #* Update for where your WPS files are
ungrib_prefix = 'MERRA' #* Update for what your meteorology IC/BC files are
merra_pgm_dir = '../merra2wps'
...
for seq, start_date, end_date in zip(seqs, start_dates, end_dates):
     with open(f'namelist.{seq}', 'a') as fl:
         ...
         fl.write(f"opt_geogrid_tbl_path = './'\n")
         fl.write(f"/\n")
         fl.write(f"\n")
         fl.write(f"&ungrib\n")
...
with open('wps_ghg.sh','a') as fl:
   ...
   fl.write(f'ln -sf {wps_dir}/geogrid/GEOGRID.TBL .\n')
